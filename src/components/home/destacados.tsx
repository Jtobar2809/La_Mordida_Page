      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {products.map((product, i) => (
          ...
          >
            ...
            <div className="p-6">
              <h3 className="font-display text-2xl tracking-wide text-charcoal-900 dark:text-cream">{product.name}</h3>
              <p className="mt-1 line-clamp-2 text-sm text-charcoal-500 dark:text-charcoal-300">{product.description}</p>
